...
function iniciaJogo(){
    ...
    //imprimir qtde baloes inteiroes
...
function contagem_tempo(segundos){
    ...
    if(segundos == -1){
        clearTimeout(timerId); // para a execução da funçao de settimeout
        game_over();
        return false;
...
function game_over(){
    alert("Você não conseguiu estourar os balões há tempo !");
